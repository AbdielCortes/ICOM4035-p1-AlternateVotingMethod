...
public class ArrayList<E> implements List<E> {
	...
	private void reAllocate() {
		...
		int size = this.size(); // store size for later use since clear() sets it to 0
		this.clear(); //Clear sets currentSize to zero, which ruins the add operation
	...
	public boolean remove(E obj) {
		...
		if (position >= 0) // found it
			return this.removeAtIndex(position);
		else
			return false;
	}
